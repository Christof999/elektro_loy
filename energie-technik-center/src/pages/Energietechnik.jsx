...
/* ── Individuelle SVG-Illustrationen pro Leistung ── */
...
function BatteryIllustration() {
  return (
    <svg viewBox="0 0 220 110" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path d="M178 32 Q200 20 210 30" stroke="#60a5fa" strokeWidth="1.5" fill="none" opacity="0.3"/>
    </svg>
  );
}
  ...
  return (
    <>
      ...
      <section style={{
        paddingTop: '8rem',
        paddingBottom: '4rem',
        background: 'linear-gradient(160deg, #0b1929 0%, #1c2d1a 55%, #0b1929 100%)',
        position: 'relative',
        overflow: 'hidden',
      }}>
        {/* Hintergrund: Sonne + Windrad in Blau – nahtlos eingebunden */}
        <EnergieSzene />

        <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
          <svg style={{ width: '100%', height: '100%', opacity: 0.03 }} aria-hidden="true">
            <defs><pattern id="eg3" x="0" y="0" width="28" height="28" patternUnits="userSpaceOnUse"><circle cx="1.5" cy="1.5" r="1.5" fill="white"/></pattern></defs>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{
            ...
            color: '#fff', lineHeight: 1.12, marginBottom: '1rem', letterSpacing: '-0.02em', maxWidth: 560,
          }}>
            Energietechnik
          </h1>
      ...
      {/* ── Leistungen: individuelle Illustrationen ── */}
            ...
            {leistungen.map((item) => {
              ...
              return (
                <div key={title} className="card reveal" style={{ overflow: 'hidden' }}>
                  {/* Illustration als Bild oben in der Karte */}
      ...
      {/* ── CTA ── */}
      <section style={{ background: 'linear-gradient(135deg, #0b1929, #0f2744)', padding: '3.5rem 0' }}>
...
/* ── Hero-Hintergrundszene Energietechnik: Sonne & Windrad in Blau ── */
  ...
  return (
    ...
    >
      <style>{`
        ...
        @keyframes es-wind{0%{transform:translateX(-50px);opacity:0}20%{opacity:1}80%{opacity:1}100%{transform:translateX(0);opacity:0}}
        ...
        .esw1{animation:es-wind 3.2s ease-in-out infinite 0s}
        .esw2{animation:es-wind 3.2s ease-in-out infinite .8s}
        .esw3{animation:es-wind 3.2s ease-in-out infinite 1.6s}
      ...
      {/* Windlinien */}
      <g stroke="#93c5fd" strokeWidth="2.2" strokeLinecap="round" fill="none" opacity="0.7">
        <path className="esw1" d="M50 125 Q88 120 130 125"/>
        <path className="esw2" d="M50 145 Q82 140 115 145"/>
        <path className="esw3" d="M50 163 Q76 159 104 163"/>
      </g>
      {/* Sonne blau */}
      <g className="esr">
      ...
      <rect x="409" y="198" width="16" height="8" rx="2" fill="#6b7280" opacity="0.5"/>
      <g className="esb2">
...
/* ── Nachhaltigkeits-Gesamtszene (kein Boxrahmen, freistehend) ── */
function NachhaltigkeitSzene() {
  return (
    <svg viewBox="0 0 400 280" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 420 }}>
      ...
      <circle cx="320" cy="50" r="24" fill="#bfdbfe" opacity="0.4"/>
      <circle cx="320" cy="50" r="18" fill="#93c5fd" opacity="0.7"/>
      <circle cx="320" cy="50" r="11" fill="#dbeafe"/>
      {/* Wolken */}
